...
- Draw first-party surfaces with a software renderer. **Windows complete; owned text foundation started:** a portable
  ...
  owned Unicode mapping, simple-outline extraction, and exact quadratic paths for a later Linux glyph source (Decisions 0133 through 0135). See `docs/RENDERER.md` and `docs/FONTS.md`.
