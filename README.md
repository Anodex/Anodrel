...
`docs/RENDERER.md` documents the renderer and brand API; `docs/FONTS.md` defines the owned Unicode-to-glyph parsing foundation, and `docs/GLYPH_RENDERING.md` its bounded path-to-canvas adapter, for a future native text path.
