...
the fixed current UI Lab raw/control-view property/tree contract through real
Windows APIs. An enabled authenticated-session button now exposes one bounded
