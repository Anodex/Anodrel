...
verification is pending. Decision 0083 now defines the planned constrained
compiled native menu template that will consume this existing boundary without
Node.js or an arbitrary capability selector.
