...
## Product and update diagnostics

The machine-trust product-fixture procedure and the fixed taskbar-update
diagnostic now live in [Product and update diagnostics](PRODUCT_DIAGNOSTICS.md).
Keeping them separate from ordinary compiled development samples makes their
machine-trust and desktop-acceptance requirements explicit.
