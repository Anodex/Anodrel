...
| Signed distribution and installation | Foundation in progress | The owned installer validates strict release manifests, complete payload bundles, and records the host validator accepts, without adding an installer framework. | Choose certificate custody, implement signed resources, staged installation, recovery, uninstall, and release verification paths. |
