...
SDK, mock-host contract, and direct WinHTTP adapter in `docs/NETWORK.md`; no
current native host attaches that adapter or grants it to an application.
