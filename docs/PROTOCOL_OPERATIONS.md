...
## Session-window presentation operations

The separate foreground and fullscreen grants, exact payloads, and safe
failure boundaries are maintained in
[session-window presentation operations](PROTOCOL_WINDOW_PRESENTATION.md).
