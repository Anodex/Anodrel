...
pub(super) fn service_window_title(window: Hwnd) {
...
pub(super) fn service_window_state(window: Hwnd) {
...
pub(super) fn service_window_focus(window: Hwnd) {
...
/// original placement.
pub(super) fn service_window_fullscreen(window: Hwnd) {
...
pub(super) fn service_window_size(window: Hwnd) {
