...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    if let [command, client_path] = arguments.as_slice()
        && command == "--uia-live-status-event-probe"
    {
        return uia_live_status_event_probe::run(client_path);
    }
    if let [command, client_path] = arguments.as_slice()
    ...
    if let [command, client_path] = arguments.as_slice()
        && command == "--native-tray-template-client"
    {
        return native_tray_template::run(client_path);
    }
    if let [command, client_path] = arguments.as_slice()
        && command == "--native-notification-template-client"
    {
        return native_notification_template::run(client_path);
    }
    if let [command, client_path] = arguments.as_slice()
        && command == "--native-file-write-template-client"
    {
        return native_file_write_template::run(client_path);
    }
    if let [command, client_path] = arguments.as_slice()
        && command == "--native-file-binary-write-template-client"
    {
        return native_file_binary_write_template::run(client_path);
    }
    if let [command, client_path] = arguments.as_slice()
    ...
    if !arguments.is_empty() {
        return Err(io::Error::new(
            ...
            "usage: anodrel-windows-host [--idle-performance-report | --ui-lab | --uia-property-probe | --uia-focus-probe | --uia-focus-event-probe | --uia-invoke-probe <native-client.exe> | --uia-structure-event-probe <native-client.exe> | --uia-live-status-event-probe <native-client.exe> | --ui-preview <document.json> | --startup-report <anodrel.application.json> | --crash-report-selftest | --window-lab | --window-group-lab | --showcase <anodrel.application.json> | --application <anodrel.application.json> | --product-session <applicationId> | --native-sample-client <native-client.exe> | --native-network-sample-client <native-client.exe> | --native-ui-sample-client <native-client.exe> | --native-template-client <native-template.exe> | --native-form-template-client <native-form-template.exe> | --native-live-status-template-client <native-live-status-template.exe> | --native-menu-template-client <native-menu-template.exe> | --native-context-menu-template-client <native-context-menu-template.exe> | --native-tray-template-client <native-tray-template.exe> | --native-notification-template-client <native-notification-template.exe> | --native-file-write-template-client <native-file-write-template.exe> | --native-file-binary-write-template-client <native-file-binary-write-template.exe> | --native-multi-window-template-client <native-multi-window-template.exe> | --native-scroll-window-template-client <native-scroll-window-template.exe> | --native-window-controls-template-client <native-window-controls-template.exe> | --sample-client <node.exe> <native-client.js> | --sample-ui-client <node.exe> <native-client.js> | --sample-ui-live-status-client <node.exe> <native-client.js> | --sample-ui-file-client <node.exe> <native-client.js> | --sample-ui-file-text-client <node.exe> <native-client.js> | --sample-ui-save-client <node.exe> <native-client.js> | --sample-ui-file-write-client <node.exe> <native-client.js> | --sample-ui-file-binary-write-client <node.exe> <native-client.js> | --sample-ui-storage-client <node.exe> <native-client.js> | --sample-ui-scroll-client <node.exe> <native-client.js> | --sample-ui-diagnostics-client <node.exe> <native-client.js> | --sample-ui-credentials-client <node.exe> <native-client.js> | --sample-ui-window-title-client <node.exe> <native-client.js> | --sample-ui-window-state-client <node.exe> <native-client.js> | --sample-ui-window-state-read-client <node.exe> <native-client.js> | --sample-ui-window-state-changes-client <node.exe> <native-client.js> | --sample-ui-window-focus-client <node.exe> <native-client.js> | --sample-ui-window-fullscreen-client <node.exe> <native-client.js> | --sample-ui-window-size-client <node.exe> <native-client.js> | --sample-ui-window-size-fullscreen-client <node.exe> <native-client.js> | --sample-ui-fields-client <node.exe> <native-client.js> | --sample-ui-menu-client <node.exe>]",
        )
        .into());
    }
