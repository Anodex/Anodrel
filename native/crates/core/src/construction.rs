...
impl CoreHost {
    ...
    pub fn with_session_components_and_service_bundle(
        ...
        Self {
            ...
            context_menu_session: RefCell::new(ContextMenuSession::new()),
            tray_session: RefCell::new(TraySession::new()),
