...
pub(crate) fn request_v1_30(operation: &str, payload: &str) -> String {
    request_at(30, operation, payload)
}

pub(crate) fn request_v1_31(operation: &str, payload: &str) -> String {
    request_at(31, operation, payload)
}
